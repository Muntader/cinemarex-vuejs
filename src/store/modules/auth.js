...
const module = {
    ...
    actions: {
            ...
            axios.post('http://localhost:8000/oauth/token', data)
                .then(response => {
                    axios
                        ...
                        .then(check => {
                            if (check.data.status === 'confirm_step') {
                                ...
                                Vue.auth.setToken(response.data.access_token, response.data.expires_in, check.data.name, check.data.email, check.data.language, 'confirm_step')
                                router.go('/')
                                ...
                                Vue.auth.setToken(response.data.access_token, response.data.expires_in, check.data.name, check.data.email, check.data.language, 'active')
                                router.go('/')
            ...
            commit('BUTTON_LOAD')
                axios.post('http://localhost:8000/api/v1/create/register', {
                    ...
                    if (response.status === 200) {
                        ...
                        axios.post('http://localhost:8000/oauth/token', data).then(response => {
                            commit('SET_USER_INFO', {
                            ...
                            this.$auth.setToken(response.data.access_token, response.data.expires_in, response.data.username, response.data.email, 'en', 'active');
                            commit('BUTTON_CLEAR')
        ...
        GET_PAYMENT({
            ...
            commit('SPINER_LOAD')
            axios.get('http://localhost:8000/api/v1/get/profile/payment')
                .then(response => {
        ...
        GET_BILLING_DETAILS({
            ...
            commit('SPINER_LOAD')
            axios.get('http://localhost:8000/api/v1/get/profile/payment/billing')
                .then(response => {
        ...
        CANCEL_MEMBERSHIP({
            ...
            swal({
                ...
                if (willDelete) {
                    commit('BUTTON_LOAD')
                    axios.get('http://localhost:8000/api/v1/update/profile/payment/cancel_membership').then(response => {
        ...
        RESUME_MEMBERSHIP({
            ...
            commit('BUTTON_LOAD')
            axios.get('http://localhost:8000/api/v1/update/profile/payment/resume_membership').then(response => {
                if (response.data.status === 'success') {
                    alertify.logPosition('top right')
        ...
        CHANGE_PLAN({
            ...
            swal({
                ...
                if (willDelete) {
                    commit('BUTTON_LOAD')
                    axios.post('http://localhost:8000/api/v1/update/profile/payment/change_plan', {
                        plan_id: plan_id
                    }).then(response => {
                        if (response.data.status === 'success') {
                            commit('SET_PLAN', {
        ...
        SET_LANGUAGE({
            ...
            axios.post('http://localhost:8000/api/v1/update/profile/language', {
                language: lang
            }).then(response => {
        ...
        SET_CAPTION({
            ...
            axios.post('http://localhost:8000/api/v1/update/profile/caption', {
                caption: caption
            }).then(res => {
                alertify.logPosition('top right')
        ...
        SUBMIT_SUPPORT_REQUEST({
            ...
            commit('BUTTON_LOAD')
            axios.post('http://localhost:8000/api/v1/create/support/request', {
                subject: subject,
                details: details
            }).then(response => {
                if (response.data.status === 'success') {
        ...
        GET_ALL_SUPPORT_REQUEST({
            ...
            commit('SPINER_LOAD')
            axios.get('http://localhost:8000/api/v1/get/support/request').then(response => {
                if (response.status === 200) {
        ...
        GET_SUPPORT_REQUEST({
            ...
            commit('SPINER_LOAD')
            axios.get('http://localhost:8000/api/v1/get/support/request/' + id).then(response => {
                if (response.status === 200) {
        ...
        SUPPORT_REPLY({
            ...
            commit('BUTTON_LOAD')
            axios.post('http://localhost:8000/api/v1/create/support/request/reply', {
                id: id,
                reply: reply
            }).then(response => {
                if (response.status === 200) {
        ...
        GET_DEVICE_ACTIVITY({
            ...
            commit('SPINER_LOAD')
            axios.get('http://localhost:8000/api/v1/get/device/activity').then(response => {
                if (response.status === 200) {
        ...
        DELETE_DEVICE_SESSION({
            ...
            axios.delete('http://localhost:8000/api/v1/delete/device/session/' + id).then(response => {
                if (response.status === 200) {
