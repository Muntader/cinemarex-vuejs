            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <div class="col-12">
                                        <input class="form-control" name="first-name" v-validate="'required|max:30'"
                                               :class="{'input': true, 'input-danger': errors.has('first-name') }"
                                               type="text" :placeholder="$t('footer.first_name')"
                                               v-model="first_name">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <div class="col-12">
                                        <input class="form-control" name="last-name" v-validate="'required|max:30'"
                                               :class="{'input': true, 'input-danger': errors.has('last-name') }"
                                               type="text" :placeholder="$t('footer.last_name')"
                                               v-model="last_name">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="col-12">
                                    <textarea class="form-control"
                                              ...
                                              name="message" v-model="message" type="text"
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <button class="btn btn-warning" @click="SEND_MESSAGE" v-if="!btn_loading">
                                    {{$t('report.send')}}
                                </button>
