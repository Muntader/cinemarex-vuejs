<template>
<div class="xjkax">
    <div class="col-12  p-0 movies-page">
                ...
                <div class="col-12 p-0 p-md-3">
                    ...
                    <div class="carousel mt-1 m-3 mb-5 mb-5" v-if=" data.recommendation !== null  && $auth.isAuthenticated()">
                        <div class="genre ml-2">
                            <h3>
                                <strong>{{$t('home.recommendation_movies')}}</strong>
                            </h3>
                        </div>
                        ...
                        <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                            ...
                            <slide class="col-6 col-md-4 col-lg-2 col-xxl-1-5 m-2 animation" v-for="(item, index) in data.recommendation" :key="index">
                                ...
                                <div class="poster" @mouseover="ACTIVE_SLELECTED_RECENLTY_MOVIE(item.id)">
                    ...
                    <div class="carousel mt-1 m-3 mb-5 mb-5" v-if=" data.popular_movies !== null && !$auth.isAuthenticated()">
                        <div class="genre ml-2">
                            <h3>
                                <strong>{{$t('home.popular_movies')}}</strong>
                            </h3>
                        </div>
                        ...
                        <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                            ...
                            <slide class="col-6 col-md-4 col-lg-2 col-xxl-1-5 m-2 animation" v-for="(item, index) in data.popular_movies" :key="index">
                    ...
                    <div class="carousel mt-1 m-3 mb-5" v-for="(item, rootindex) in data.movies" :key="rootindex" v-if="item.list.length > 0 ">
                        <div class="genre ml-2">
                            <h3>
                        ...
                        <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                            ...
                            <slide class="col-6 col-md-4 col-lg-2 col-xxl-1-5 m-2 animation" v-for="(item, index) in data.movies[rootindex].list" :key="index">

                                <div class="poster" @mouseover="ACTIVE_SLELECTED_MOVIE(item.id, rootindex )">
        ...
        <div v-if="!loading && data.movies == null">
...
export default {
    ...
    computed: mapState({
        ...
        loading: state => state.movies.movie_loading
    }),
    ...
    methods: {
        ...
        HIDE_COLLECTION_MODAL_SAVE() {
            if (this.$auth.isAuthenticated()) {
                ...
                if (this.collection.rootindex !== null) {
                    // For list
                    this.data.movies[this.collection.rootindex].list[
        ...
        DELETE_FROM_COLLECTION(id, type, rootindex, index) {
            if (this.$auth.isAuthenticated()) {
                if (rootindex !== null) {
                    // For list
                    this.data.movies[rootindex].list[index].is_favorite = false;
                } else {
                    // For top
        ...
        ADD_NEW_LIKE(id, type, rootindex, index, type1) {
            if (this.$auth.isAuthenticated()) {
                if (type1 === "add") {
                    ...
                    this.data.movies[rootindex].list[index].is_like = true;
                    ...
                    this.data.movies[rootindex].list[index].is_like = false;
        ...
        ACTIVE_SLELECTED_RECENLTY_MOVIE(id) {
            this.active_series = null;
            this.active_movie = id;
        }
    },
