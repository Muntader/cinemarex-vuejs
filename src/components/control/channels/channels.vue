<template>
    <div class="xjkax">
        ...
        <div class="col-12 live-page">
            ...
            <div class="carousel mt-1 m-3 mb-5 mb-5" v-for="(item, rootindex) in data.channels" :key="rootindex" v-if="item.list.length > 0 ">
                ...
                <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                    ...
                    <slide class="col-6 col-md-4 col-lg-3 col-xl-1-5 col-xxl-1-8" v-for="(item, index) in data.channels[rootindex].list" :key="index">
                        <div class="animation-tv">
                            <router-link :to="{name: 'tv-player', params:{id: item.tv_id}}">
                                <div class="tv-logo">
                                    <progressive-img :src="site_link + '/storage/posters/' + item.image" :alt="item.name" width="100%" />
                                </div>
        ...
        <div v-if="data.channels == null && !loading">
