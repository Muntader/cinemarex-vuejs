<template>
<div class="xjkax">
    <div class="col-12 p-0 kids-page">
                ...
                <carousel class="list-carousel" :navigationEnabled="false" :paginationEnabled="true" :autoplay="true" :autoplayTimeout="2000" easing="ease-in-out" :perPageCustom="[[220,1], [420,1],[768, 1], [1024, 1]]">
                    ...
                    <slide v-for="(item,index) in data.top" :key="index">
                        ...
                        <div class="top-item__film-cover" v-if="item.type === 'movie'">
                            ...
                            <img :src="site_link + '/storage/backdrops/original_' + item.backdrop" :alt="item.name" width="100%" class="backdrop" v-if="item.cloud == 'local' ">
                            <img :src=" lg_backdrop + item.backdrop" :alt="item.name" width="100%" class="backdrop" v-if="item.cloud == 'aws' ">
                            <router-link :to="{name: 'show-movie', params:{id: item.id}}" class="hidden-sm-down">
                                <div class="top-item__film-ovarlay">
                                    ...
                                    <div class="top-item__film-details">
                                        ...
                                        <div class="control">
                                            ...
                                            <router-link role="button" class="btn-slide-to" :to="{name: 'movie-player', params: {id: item.id}}">
                            ...
                            <router-link :to="{name: 'show-movie', params:{id: item.id}}" class="hidden-md-up">
                                <div class="top-item__film-ovarlay">
                                ...
                                <div class="top-item__film-ovarlay">
                                    ...
                                    <div class="top-item__film-details">
                                        <div class="hidden-sm-down poster">
                                            <img :src="site_link + '/storage/posters/300_' + item.poster" :alt="item.name" class="poster" v-if="item.cloud == 'local'">
                                            ...
                                            <div class="control">
                                                ...
                                                <router-link role="button" class="btn-slide-to" :to="{name: 'series-player', params: {series_id: item.id}}">
            ...
            <div class="col-12">
                <div class="row" style="margin: -30px; overflow: hidden;">
                    <div class="col-12 p-0 p-md-3">
                        ...
                        <div class="carousel mt-1 m-3 mb-5 mb-5" v-for="(item, rootindex) in data.kids" :key="rootindex" v-if="item.list.length > 0 ">
                            <div class="genre ml-2">

                                <h3 v-if="data.kids[rootindex].type === 'Movies'">
                                    <strong >
                                            {{item.genre}}
                                ...
                                <h3 v-if="data.kids[rootindex].type === 'Series'">
                                    <strong> {{item.genre}}
                            ...
                            <carousel class="list-carousel" navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                                ...
                                <slide class="col-6 col-md-4 col-lg-2 col-xxl-1-5 m-2 animation" v-for="(item, index) in data.kids[rootindex].list" :key="index">

                                    <div class="poster" @mouseover="ACTIVE_SLELECTED_MOVIE(item.id, rootindex )" v-if="data.kids[rootindex].type === 'Movies'">
                                                    ...
                                                    <div class="header pull-right">
                                                        ...
                                                        <div class="mt-0">
                                                            ...
                                                            <div class="poster__add-collection-icon text-right" v-if="! item.is_favorite">
                                                                ...
                                                                <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%" @click.prevent="SHOW_COLLECTION_MODAL(item.id, site_link + '/storage/backdrops/600_' + item.backdrop, item.name, 'movie', rootindex, index)"  v-if="item.cloud == 'local'">
                                                                <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%" @click.prevent="SHOW_COLLECTION_MODAL(item.id, md_backdrop + item.backdrop, item.name, 'movie', rootindex, index)"  v-if="item.cloud == 'aws'">

                                                                </div>

                                                                <div class="poster__remove-collection-icon text-right" v-if="item.is_favorite">
                                                                    <img src="../../../assets/default/img/favor.svg" alt="favor" width="100%" @click.prevent="DELETE_FROM_COLLECTION(item.id, 'movie', rootindex, index)" >
                                                                ...
                                                                <div class="mt-1">
                                                                    ...
                                                                    <div class="poster__add-like-icon text-right" v-if="! item.is_like">
                                                                        <img src="../../../assets/default/img/dislike.svg" alt="dislike" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'movie', rootindex, index, 'add')">
                                                                </div>

                                                                        <div class="poster__remove-like-icon  text-right" v-if="item.is_like">

                                                                            <img src="../../../assets/default/img/like.svg" alt="dislike" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'movie', rootindex, index, 'delete')">
                                    ...
                                    <div class="poster" @mouseover="ACTIVE_SLELECTED_SERIES(item.id, rootindex)" v-if="data.kids[rootindex].type === 'Series'">
        ...
        <div v-if="!loading && data.kids == null">
    ...
    methods: {
        ...
        HIDE_COLLECTION_MODAL_SAVE() {
            if (this.$auth.isAuthenticated()) {
                ...
                if (this.collection.rootindex !== null) {
                    // For list
                    this.data.kids[this.collection.rootindex].list[
        ...
        DELETE_FROM_COLLECTION(id, type, rootindex, index) {
            if (this.$auth.isAuthenticated()) {
                if (rootindex !== null) {
                    // For list
                    this.data.kids[rootindex].list[index].is_favorite = false;
                } else {
                    // For top
        ...
        ADD_NEW_LIKE(id, type, rootindex, index, type1) {
            if (this.$auth.isAuthenticated()) {
                if (type1 === "add") {
                    ...
                    this.data.kids[rootindex].list[index].is_like = true;
                    ...
                    this.data.kids[rootindex].list[index].is_like = false;
