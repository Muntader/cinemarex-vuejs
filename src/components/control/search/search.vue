    ...
    <div class="col-12 search-page">
        ...
        <div class="row">
            ...
            <div class="p-sm-5 p-lg-5" v-if="data.data !== null || data.cast !== null">
                        ...
                        <div class="text-center">
                            <router-link :to="{name: 'cast', params: {id: item.id}}">
                                <div class="image" @mouseover="showCast = index">
                                    <img :src="site_link + item.image" :alt="item.name" width="100%" v-if="item.cloud === 'local' ">
                ...
                <div class="col-12" v-if="data.data !== null">

                    <div class="row" style="margin: -30px; overflow: hidden;">
                        <div class="col-12 p-0">

                            <div class="carousel mt-1 m-3 mb-5 mb-5" v-for="(item, rootindex) in data.data" :key="rootindex" v-if="item.list.length > 0 ">
