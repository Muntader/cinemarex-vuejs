        ...
        <div class="col-12 cast-page mt-4 p-2 p-sm-2 p-lg-2">
            ...
            <div class="cast-page__cast">
                <div class="col-8 col-sm-12 hidden-xs-down ipad-up text-center">
                    <div class="image">
                        <img :src="site_link + data.cast.image" :alt="data.cast.name" width="100%" v-if="data.cast.cloud === 'local'">
            ...
            <div class="col-12 mt-5" v-if="data.filmography !== null">
                ...
                <carousel navigationPrevLabel='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 129 129" enable-background="new 0 0 129 129" width="100%" class="arrow-right-svg"><g><g>
                    ...
                    <slide class="col-6 col-md-4 col-lg-3 col-xl-1-5 col-xxl-1-8 p-1 animation" v-for="(item, index) in data.filmography" :key="index">
                            ...
                            <div class="poster" @mouseover="ACTIVE_SLELECTED_MOVIE(item.id )">
                                ...
                                <router-link :to="{name: 'show-movie', params: {id: item.id}}">
                                    ...
                                    <div class="poster__backdrop-image">
                                        ...
                                        <img :src="site_link + '/storage/backdrops/600_' + item.backdrop" :alt="item.name" width="100%" v-if="item.cloud === 'local'">
                                            ...
                                            <div class="header pull-right">
                                                ...
                                                <div class="mt-0">
                                                    ...
                                                    <div class="poster__add-collection-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%"  @click.prevent="SHOW_COLLECTION_MODAL(item.id, site_link + '/storage/backdrops/600_' + item.backdrop, item.name, 'movie', index)"  v-if="item.cloud == 'local'">
                                                        <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%"  @click.prevent="SHOW_COLLECTION_MODAL(item.id, md_backdrop + item.backdrop, item.name, 'movie', index)" v-if="item.cloud == 'aws'" >
                                                    ...
                                                    <div class="poster__remove-collection-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/favor.svg" alt="favor" width="100%" @click.prevent="DELETE_FROM_COLLECTION(item.id, 'movie', index)" >
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <div class="poster__add-like-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/dislike.svg" alt="dislike" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'movie', index, 'add')">
                                                    ...
                                                    <div class="poster__remove-like-icon  text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/like.svg" alt="like" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'movie', index, 'delete')">
                                            ...
                                            <div class="header pull-right">
                                                ...
                                                <div class="mt-0">
                                                    ...
                                                    <div class="poster__add-collection-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%"  @click.prevent="SHOW_COLLECTION_MODAL(item.id, site_link + '/storage/backdrops/600_' + item.backdrop, item.name, 'search', index)"  v-if="item.cloud == 'local'">
                                                        <img src="../../../assets/default/img/infavor.svg" alt="favor" width="100%"  @click.prevent="SHOW_COLLECTION_MODAL(item.id, md_backdrop + item.backdrop, item.name, 'search', index)" v-if="item.cloud == 'aws'" >
                                                    ...
                                                    <div class="poster__remove-collection-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/favor.svg" alt="favor" width="100%" @click.prevent="DELETE_FROM_COLLECTION(item.id, 'search', index)" >
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <div class="poster__add-like-icon text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/dislike.svg" alt="dislike" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'search', index, 'add')">
                                                    ...
                                                    <div class="poster__remove-like-icon  text-right"
                                                        ...
                                                        <img src="../../../assets/default/img/like.svg" alt="like" width="100%" @click.prevent="ADD_NEW_LIKE(item.id, 'search', index, 'delete')">
