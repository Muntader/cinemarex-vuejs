                                    ...
                                    <div class="poster" @mouseover="ACTIVE_SLELECTED_MOVIE(item.id)">
                                        ...
                                        <router-link :to="{name: 'show-movie', params: {id: item.id}}">
                                            <div class="poster__backdrop-image">
                                                ...
                                                <progressive-img :src="site_link + '/storage/posters/600_' + item.poster"
                                                                 placeholder="../../../assets/default/img/loader-image.png"
                                                                 :alt="item.name"
                                                                 width="100%"
                                                                 :aspect-ratio="1.5"
                                                ...
                                                <div class="poster__backdrop_overlay-info"
                                                    ...
                                                    <div class="body text-center">
                                                        ...
                                                        <div class="play">
                                                            ...
                                                            <router-link
                                                                    :to="{name: 'movie-player-embed', params: {id: item.id}}"
                                                                    v-if="item.player == 'embed'  ">
                                                        ...
                                                        <div class="header pull-right">
                                                            ...
                                                            <div class="mt-0">
                                                                ...
                                                                <div class="poster__remove-collection-icon text-right"
                                                                    ...
                                                                    <img src="../../../assets/default/img/favor.svg" alt="favor" width="100%" @click.prevent="DELETE_FROM_COLLECTION(item.id, 'series', index)" >
                                                        ...
                                                        <div class="body text-center">
                                                            ...
                                                            <div class="play">
                                                                ...
                                                                <g>
                                                                    ...
                                                                    <router-link
                                                                            :to="{name: 'series-player-embed-current', params: {series_id: item.id}}"
                                                                            v-if="item.player == 'embed'  ">
